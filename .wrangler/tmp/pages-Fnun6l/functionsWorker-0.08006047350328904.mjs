...
async function ensureTables(env) {
  ...
  await env.DB.exec("CREATE TABLE IF NOT EXISTS content (id INTEGER PRIMARY KEY AUTOINCREMENT, section TEXT UNIQUE NOT NULL, title TEXT NOT NULL DEFAULT '', body TEXT NOT NULL DEFAULT '', updated_by INTEGER, updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (updated_by) REFERENCES users(id))");
  const sections = ["personal", "movies", "books", "music", "memos", "profile"];
...
async function onRequest(context) {
  ...
  try {
    ...
    if (path.startsWith("content/") && method === "PUT") {
      ...
      if (!["personal", "movies", "books", "music", "memos", "profile"].includes(section)) return errorResponse("\u65E0\u6548\u7684\u677F\u5757");
...
// ../.wrangler/tmp/pages-Fnun6l/functionsRoutes-0.24046835270592115.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// C:/Users/Yohann/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/Yohann/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-Wnk4Va/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Wnk4Va/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.08006047350328904.mjs.map
