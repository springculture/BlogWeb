...
async function onRequest(context) {
  ...
  try {
    ...
    if (path === "guestbook" && method === "POST") {
      ...
      if (content.length > 1e3) return errorResponse("\u5185\u5BB9\u4E0D\u80FD\u8D85\u8FC71000\u5B57");
...
// ../.wrangler/tmp/pages-vaE0cr/functionsRoutes-0.36561535210297014.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-eymPA3/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-eymPA3/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.07926849514467205.mjs.map
